...
export function useAppController() {
  ...
  return {
    state: {
      ...
      hasMoreExpenses: groupController.state.hasMoreExpenses,
      expensesPageLoading: groupController.state.expensesPageLoading,
      expensesPageError: groupController.state.expensesPageError,
      hasMoreSettlements: groupController.state.hasMoreSettlements,
      settlementsPageLoading: groupController.state.settlementsPageLoading,
      settlementsPageError: groupController.state.settlementsPageError,
      settlementExpensePages: groupController.state.settlementExpensePages,
      ...
      friendDirectory: dashboardController.state.friendDirectory,
      friendsLoading: dashboardController.state.friendsLoading,
      friendsError: dashboardController.state.friendsError,
      selectedFriendId: dashboardController.state.selectedFriendId,
      displayName,
      email,
      password,
    ...
    actions: {
      ...
      onSelectFriend: dashboardController.actions.onSelectFriend,
      onOpenGroupPage: groupController.actions.onOpenGroupPage,
      ...
      onLoadOlderExpenses: groupController.actions.onLoadOlderExpenses,
      onLoadMoreSettlements: groupController.actions.onLoadMoreSettlements,
      onLoadSettlementExpenses: groupController.actions.onLoadSettlementExpenses,
